...
const UserWorkshops = () => {
  ...
  // دالة لضمان الصعود لأعلى الصفحة فور الضغط على زر التسجيل
            ...
            {forms.map((form) => {
              ...
              return (
                <div 
                  ...
                  className="bg-[#23233c] border border-orange-500/10 rounded-2xl overflow-hidden shadow-lg flex flex-col justify-between hover:border-orange-300 transition duration-300"
                  dir={isAr ? 'rtl' : 'ltr'}
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between">
                    ...
                    {/* زر الانتقال لصفحة التسجيل مع إعادة التمرير للأعلى */}
                    <Link
                      to={`/forms/${form.slug}`}
