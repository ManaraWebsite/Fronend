...
const CreateForm = () => {
  ...
  const [fields, setFields] = useState([
    { id: 1, type: 'text', label: 'Full name', placeholder: 'Enter your full name', helpText: '', required: true, options: null },
    { id: 2, type: 'email', label: 'Email address', placeholder: 'you@example.com', helpText: '', required: true, options: null },
    { id: 3, type: 'tel', label: 'Phone number', placeholder: '+1 555 000 0000', helpText: '', required: true, options: null },
    { 
      id: 4, 
      type: 'select', 
      label: 'University', 
      ...
      helpText: '', 
      required: true, 
      options: ['UCAS', 'Al-Aqsa University', 'Islamic University of Gaza', 'Palestine University', 'Other']
    }
  ]);
    ...
    <div className="p-8 max-w-7xl mx-auto min-h-screen bg-[#0d1117] text-gray-100" dir="ltr">
      <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-4">
        <div>
          ...
          <h1 className="text-xl font-bold text-white">Create Single-Page Form</h1>
        </div>
      </div>
      ...
      <div className="flex justify-end items-center gap-3 mt-8 pt-4 border-t border-gray-800">
        <button type="button" onClick={() => handleSubmit('Draft')} disabled={loading} className="px-5 py-2.5 bg-[#161b22] border border-gray-800 text-gray-300 rounded-xl text-sm font-semibold hover:bg-gray-800 transition cursor-pointer">
          {loading ? 'Saving...' : 'Save as Draft'}
        </button>
        <button type="button" onClick={() => handleSubmit('Published')} disabled={loading} className="px-5 py-2.5 bg-[#ff7a00] text-white rounded-xl text-sm font-semibold hover:bg-[#e06c00] transition shadow-sm flex items-center gap-2 cursor-pointer">
          <FiCheck />
